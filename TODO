...
<strong>[X] Фильтрация по рейтингу </strong> 
<br>
<strong>[X] Фильтрация по сезону </strong> 
<br>
<strong>[X] Фильтрация по студиям </strong> 
<br>
<strong>[X] Фильтрация по статусу выхода </strong> 
<br>
<strong>[X] Упорядочить по: </strong> 
<br>
[0%] Сделать красиво
...
<br>
[0%] Открытие картинки на полный экран
<br>
<strong>[X] Персонажи</strong>
<br>
[x] Внутренний плеер 
<br>
[40%] Выбор эпизода
